...
Static Function MenuDef()
    ...
    If (IIF(Type("l_Browse") == "L", l_Browse, .F.)) == .T.
	    ADD OPTION aRotina TITLE 'Visualizar'  			ACTION 'VIEWDEF.KCOMF036' OPERATION MODEL_OPERATION_VIEW   ACCESS 0 //OPERATION 1
	    // ADD OPTION aRotina TITLE 'Incluir'    			ACTION 'VIEWDEF.KCOMF036' OPERATION MODEL_OPERATION_INSERT ACCESS 0 //OPERATION 3
	    // ADD OPTION aRotina TITLE 'Alterar'    			ACTION 'VIEWDEF.KCOMF036' OPERATION MODEL_OPERATION_UPDATE ACCESS 0 //OPERATION 4
	    // ADD OPTION aRotina TITLE 'Excluir'    			ACTION 'VIEWDEF.KCOMF036' OPERATION MODEL_OPERATION_DELETE ACCESS 0 //OPERATION 5
